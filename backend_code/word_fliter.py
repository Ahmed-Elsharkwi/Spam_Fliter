...
"""
import json
from database.data_operations import insert_data, get_data_with_email, close_session
...
def words_filter(content="", email=""):
    ...
    percentage_spam = float(info["prob_spam_emails"])
    result = ""
    ...
    return result
print(words_filter("Hello sir how are you You are the winner Winner WINNER of THE prize", "mohmed@gmail.com"))
